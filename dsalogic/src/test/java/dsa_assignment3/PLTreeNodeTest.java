...
public class PLTreeNodeTest
{
	...
	@Ignore
	public void elim() {
		NodeType[] firstBuild = { NodeType.A, NodeType.B, NodeType.IMPLIES };
		PLTreeNodeInterface firstBuildBuilt = PLTreeNode.reversePolishBuilder(firstBuild);
		logger.debug(firstBuildBuilt.toStringInfix());
		NodeType[] cor = { NodeType.A, NodeType.NOT, NodeType.B, NodeType.OR};
		PLTreeNodeInterface cor1 = PLTreeNode.reversePolishBuilder(cor);
		logger.debug(cor1.toStringInfix());
		firstBuildBuilt.eliminateImplies();
		assertEquals("First push not down", firstBuildBuilt.toStringInfix(), cor1.toStringInfix());
		NodeType[] cor2 = {NodeType.A, NodeType.B, NodeType.IMPLIES, NodeType.C, NodeType.D, NodeType.IMPLIES, NodeType.AND};
		PLTreeNodeInterface cor3 = PLTreeNode.reversePolishBuilder(cor2);
		logger.debug(cor3.toStringInfix());
		cor3.eliminateImplies();
		logger.debug(cor3.toStringInfix());
		NodeType[] cor4 = {NodeType.A, NodeType.NOT, NodeType.B, NodeType.OR, NodeType.C, NodeType.NOT, NodeType.D, NodeType.OR, NodeType.AND};
		PLTreeNodeInterface cor5 = PLTreeNode.reversePolishBuilder(cor4);
		logger.debug(cor5.toStringInfix());
		assertEquals("second push not down", cor3.toStringInfix(), cor5.toStringInfix());
		
	}
	@Test
	public void pushNotDownTest1() {
		NodeType[] cor1 = {NodeType.A, NodeType.NOT, NodeType.NOT};
		PLTreeNodeInterface cor2 = PLTreeNode.reversePolishBuilder(cor1);
		logger.debug(cor2.toStringInfix());
		NodeType[] cor3 = {NodeType.A};
		PLTreeNodeInterface cor4 = PLTreeNode.reversePolishBuilder(cor3);
		logger.debug(cor4.toStringInfix());
		cor2.eliminateImplies();
		assertEquals("even small test", cor4.toStringInfix(), cor2.toStringInfix());
	}
	@Test
	public void pushNotDownTest2() {
